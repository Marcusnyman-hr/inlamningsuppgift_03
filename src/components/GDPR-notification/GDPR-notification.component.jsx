  ...
  return (
    <div className="GDPRnotification">
      ...
      <div className='privacy-policy'>
        ...
        <li>
        <p><strong>Website</strong> refers to Income/expense tracker, accessible from <a href="www.marcusnyman.se" rel="external nofollow noopener" target="_blank">www.marcusnyman.se</a></p>
        </li>
        <li>
